            ...
            <table class="w-full text-left table-auto min-w-max">
                <thead>
                    <tr>
                        ...
                        <th class="p-4 border-b border-blue-gray-100 bg-blue-gray-50">Carrera</th>
                    ...
                    @foreach ($estudiantes as $estudiante)
                        <tr class="hover:bg-blue-100">
                            ...
                            <td class="py-2 px-4 border-b border-gray-300">
                                ...
                                class="bg-cyan-500 hover:bg-cyan-600 text-white font-bold py-2 px-4 rounded transition duration-200">
                                    Ver
                                </a>
                            </td>
                        </tr>
